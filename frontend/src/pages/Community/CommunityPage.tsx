      ...
      <div className="space-y-4">
        {filteredPosts.length === 0 ? (
          <GlassCard className="p-12 text-center" hover={false}>
            ...
            <h3 className="text-xl font-semibold text-calm-800 dark:text-white mb-6">
                  ...
                  <div>
                    ...
                    >
                      {categories.slice(1).map((cat) => (
                        <option key={cat.id} value={cat.id} className="bg-white dark:bg-calm-900 text-calm-800 dark:text-white">
                          {cat.label}
                        </option>
                      ))}
                    </select>
